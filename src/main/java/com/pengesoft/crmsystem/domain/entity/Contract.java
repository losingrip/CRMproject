 ...
 */
public class Contract extends DataPacket {
    ...
    public void assignFrom(DataPacket sou) {
        ...
        Contract s = (sou instanceof Contract) ? (Contract)sou : null;
        if (s != null){
            ...
            if (s.invoiceApplyList != null){
                this.invoiceApplyList = new InvoiceApplyList();
                this.invoiceApplyList.assignFrom(s.invoiceApplyList);
            }
        }
    }
